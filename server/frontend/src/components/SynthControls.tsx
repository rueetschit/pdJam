...
import '../App.css';
import {SettingName, SynthSettings} from '../types/SynthSettings';
...
interface IProps {
  ...
  synthSettingsService: SynthSettingsService;
}
...
class SynthControls extends React.Component<IProps, IState> {
  ...
  render() {
    const {settings, showDisabledMessage, synthSettingsService} = this.props;
        ...
        <div className="synth-controls">
          <div>
            ...
            <input
              ...
              onChange={(e) => synthSettingsService.updateSettings(SettingName.FREQUENCY, parseInt(e.target.value))}
              id="frequency-slider"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => synthSettingsService.updateSettings(SettingName.ATTACK, parseInt(e.target.value))}
              id="attack-slider"/>
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => synthSettingsService.updateSettings(SettingName.DECAY, parseInt(e.target.value))}
              id="decay-slider"/>
          </div>
          ...
          <div>
            ...
            <input
              ...
              id="pause-slider"
              onChange={(e) => synthSettingsService.updateSettings(SettingName.PAUSE, parseInt(e.target.value))}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => synthSettingsService.updateSettings(SettingName.LENGTH, parseInt(e.target.value))}
              id="length-slider"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => synthSettingsService.updateSettings(SettingName.MOD_FREQ, parseInt(e.target.value))}
              id="modfreq-slider"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => synthSettingsService.updateSettings(SettingName.MOD_AMOUNT, parseInt(e.target.value))}
              id="modamount-slider"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => synthSettingsService.updateSettings(SettingName.MOD_FREQ_2, parseInt(e.target.value))}
              id="modfreq2-slider"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => synthSettingsService.updateSettings(SettingName.MOD_FREQ_2_AMOUNT, parseInt(e.target.value))}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => synthSettingsService.updateSettings(SettingName.LFO, parseInt(e.target.value))}
              id="lfo-slider"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => synthSettingsService.updateSettings(SettingName.REVERB, parseInt(e.target.value))}
              id="reverb-slider"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => synthSettingsService.updateSettings(SettingName.VOLUME, parseInt(e.target.value))}
              id="volume-slider"
            />
          </div>
